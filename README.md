...
# Move the corresponding genome_prokka/genome.gff files to a new directory named as the representative genome according to the dRep table drep_output/data_tables/Cdb.csv
panaroo -i rep_genome/*.gff \
   -t ${cpus} \
...
# In addition, you will need to create at least the indexed database for Sourmash kmer = 21 of your representative genomes
