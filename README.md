...
Custom MAG catalogues generated using a minimal version of the [MGnify genomes-catalogue-pipeline](https://github.com/EBI-Metagenomics/genomes-catalogue-pipeline) can be used to build SHallowmapping databases. The process should be as follows:
...
# Taxonomic annotation of representatives


# Functional annotation of representatives
