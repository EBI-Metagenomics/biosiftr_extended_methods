...
This section corresponds to the post-processing of taxonomic tables generated by the different methods. When needed, the transformation from NCBI taxonomy to GTDB was made to GTDB r207.
...
# Integrating taxonomic tables. All use GTDB r207 (Greengenes2 2022.10, motus)

matrix_integrator.py --input relab_amplicon.tsv relab_motus.tsv shallow_taxo.tsv shogun_taxo.tsv --output taxonomy_relab.tsv
...
Taxonomy plots were generated using the following code in R
