...
Integration of functional tables generated by the different methods

```bash

/nfs/production/rdf/metagenomics/pipelines/prod/shallowmapping/bin/matrix_integrator.py --input picrust2.tsv micfunpred.tsv deep_kos.tsv shallow.tsv shogun_kos.tsv --output mixed_vals_kos.tsv
